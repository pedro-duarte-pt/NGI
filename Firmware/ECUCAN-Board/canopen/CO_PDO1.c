...
const unsigned long uRPDOMap1 = 0x02292312L;
const unsigned long uRPDOMap2 = 0x38947928L;
const unsigned long uRPDOMap3 = 0x02292312L;
const unsigned long uRPDOMap4 = 0x38947928L;

// make sure function is not removed by optimizer
asm("GLOBAL __CO_COMM_RPDO1_COBIDAccessEvent");
