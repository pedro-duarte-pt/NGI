...
{	
	...
	_uSDO1_CS_COBID.word = (unsigned) 0x600L + _uCO_nodeID.byte;
	...
	_uSDO1_SC_COBID.word = (unsigned) 0x580L + _uCO_nodeID.byte;
			...
			case 0x00:		// Download
				...
				{				
					...
					*((_DATA7*)(_uSDO1RxBuf + _uSDO1Dict.reqOffst)) = *((_DATA7*)(mCANGetPtrRxData() + 1));
					...
					_uSDO1Dict.reqOffst += (unsigned) (~_uSDO1Ctl.rctl.n) & 0x07; 	
				...
				{					
					...
					if (_uSDO1Dict.ctl & WR_BIT)  	
					{
						...
						if (_uSDO1Ctl.ictl.e)
						{
							...
							if (_uSDO1Ctl.ictl.s) _uSDO1Dict.reqLen = (unsigned) (((~_uSDO1Ctl.ictl.n) & 0x03) + 1);
							...
							if (_uSDO1Dict.reqLen == _uSDO1Dict.len)
							{
								...
								_uSDO1Dict.pReqBuf = (unsigned char *) (mCANGetPtrRxData() + 4);
