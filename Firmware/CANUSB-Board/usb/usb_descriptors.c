...
const USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0x6666,                 // Vendor ID: 0x6666 is Prototype product Vendor ID
    0x0A02,                 // Product ID: 0x0A01 is placeholer while in prototyping phase
...
{'M','i','c','r','o','c','h','i','p',':',' ','U','S','B',' ','2',
' ','C','A','N','O','P','E','N',' ','D','e','v','i','c','e'}};
